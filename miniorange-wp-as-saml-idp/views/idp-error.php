...
if ( isset( $count ) && ! empty( $count ) ) {
	echo '<div>
					...
					Contact us at wpidpsupport@xecurify.com or use the support form if you want to increase the limit.
					<br/><br/>';
} else {
	echo '<p>Invalid Action. Please contact us at wpidpsupport@xecurify.com or use the support form.</p>';
}
