 ...
 * the Attribute / Role Mapping tab.
 *
...
if ( ! defined( 'ABSPATH' ) ) {
	...
	echo '<div class="mo-idp-divided-layout mo-idp-full mo-idp-bg mo-idp-margin-left mo-idp-pt">
            <div class="mo-idp-table-layout mo-idp-center mo-idp-sp-width">
                <h2 class="mo-idp-add-new-sp">    
					...
					wp_nonce_field( $idp_change_name_id_nonce );
	...
	echo '					
			...
			echo ' <a href="' . esc_url( $license_url ) . '" target="_blank" class="mo-idp-advt mo-idp-upload-data-anchor">';
			...
			echo ' <img class="mo-idp-advt-premium-feature-lock-attr-map" src="' . esc_url( MSI_LOCK ) . '"/>';
