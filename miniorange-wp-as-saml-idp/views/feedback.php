<?php
/**
 * This is the file for displaying the view for
...
echo '
			...
			<div id="mo-idp-feedback-modal" class="mo-idp-modal">
				...
				echo '  <div class="mo-idp-keep-conf-intact" id="mo-idp-keep-configuration-intact">
                        <b style="color:red;">Keep Configuration Intact</b>
                        <label class="mo-idp-switch" style="float:right">
                            <input type="checkbox" name="idp_keep_settings_intact" id="keepSettingsIntact" ' . ( $keep_settings_intact ? 'checked' : '' ) . '>
                            <span class="mo-idp-slider round"></span>
                        </label>
                        <br>
                        <br>
                        <p>Enabling this would keep your settings intact when plugin is uninstalled.
                        Please enable this option when you are updating to a Premium version.    
                        </p>
                    </div>';
					echo '<br>
                            <!--  overall padding -->
...
echo '" readonly="readonly"/>
                                        <input type="radio" name="idp_edit" id="idp_edit" onclick="editIDPName()" value=""/>
											...
											echo esc_url( MSI_URL ) . '/includes/images/61456.png';
											echo '"/>
                                        </label>
                                   </div>
